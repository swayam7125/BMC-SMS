    ...
    function getNotificationIcon($type)
    {
        switch ($type) {
            ...
            case 'librarian_salary':
                return 'fas fa-receipt text-white';
            case 'hr_salary':
                return 'fas fa-receipt text-white'; // ADDED: Icon for HR salary
            default:
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        ['title' => 'Teacher Transport', 'url' => 'pages/transport/teacher_transport.php', 'roles' => ['principal']],
        ['title' => 'Librarian Transport', 'url' => 'pages/transport/librarian_transport.php', 'roles' => ['principal']],
        ['title' => 'HR Transport', 'url' => 'pages/transport/hr_transport.php', 'roles' => ['principal']],
