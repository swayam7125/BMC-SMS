...
41	6	2025-08-27	2025-08-28	e	Full Day	Pending	2025-08-14 08:57:14.360654+00	\N
\.
...
140	15	6	hii	2025-08-13 13:16:57.343686+00	f
...
439	54	New notice from Principal: Checking...	pages/teacher/view_notice.php	f	2025-08-14 08:51:44.463406+00	school_notice
...
454	10	New leave request from Meet Patel	pages/principal/teacher_leave_management.php	f	2025-08-14 08:57:14.360654+00	leave_request
\.
...
109	10	4	2025-08-14	Absent	21.18435710	72.79023360	08:54:51.275604	2025-08-14 02:22:15.482863+00
\.
...
SELECT pg_catalog.setval('public.assignments_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.exam_timetables_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.leave_applications_id_seq', 41, true);
...
SELECT pg_catalog.setval('public.messages_id_seq', 140, true);
...
SELECT pg_catalog.setval('public.principal_attendance_id_seq', 116, true);
...
SELECT pg_catalog.setval('public.principal_to_bmc_notices_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.principal_to_librarian_notices_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.school_notice_recipients_id_seq', 124, true);
...
SELECT pg_catalog.setval('public.school_notices_content_id_seq', 30, true);
