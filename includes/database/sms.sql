...
49	57	4	2025-08-19	Leave	\N	10	2025-08-19 08:05:11.913458+00
\.
...
1	57	10	4	8	2025	21000.00	23	8.0	3	2739.13	7304.35	2025-08-19 08:41:58.176302+00	Paid
\.
...
6	12	10	4	8	2025	10000.00	23	13	3	1304.35	5652.17	2025-08-19 08:29:27.155238+00	Paid
\.
...
155	10	4	2025-08-19	Absent	21.18834630	72.79392710	08:46:40.261698	2025-08-19 08:00:45.51607+00
\.
...
85	4	11	Monday	1	Computer Science	49	08:00:00	09:00:00
...
91	4	12	Monday	1	Social Studies	92	14:00:00	15:00:00
92	4	12	Tuesday	1	Physical Education	51	14:00:00	15:00:00
93	4	12	Wednesday	1	Social Studies	92	14:00:00	15:00:00
94	4	12	Thursday	1	Physical Education	51	14:00:00	15:00:00
95	4	12	Friday	1	Social Studies	92	14:00:00	15:00:00
96	4	12	Saturday	1	Physical Education	51	14:00:00	15:00:00
\.
...
6	pages/teacher/uploads/teacher_68a435a9d28652.02773764.jpg	Meet Patel	9852142010	4	2005-09-04	Male	AB+	Motavarachha	meet@gmail.com	$2y$10$sdz4DZ5oaMJNrUA9mld44uiBNIIkAQCPjs2XrrnUcl.Bp6wlzYz1a	B.C.A	Maths, Chemistry	english	100000	{10,11}	10	Evening	t	11
...
246	92	4	2025-08-19	Half Day	\N	10	2025-08-19 08:04:48.5524+00
247	6	4	2025-08-19	Leave	\N	10	2025-08-19 08:04:48.5524+00
248	70	4	2025-08-19	Half Day	\N	10	2025-08-19 08:04:48.5524+00
...
SELECT pg_catalog.setval('public.holidays_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.librarian_attendance_attendance_id_seq', 49, true);
...
SELECT pg_catalog.setval('public.librarian_payroll_records_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.notifications_id_seq', 601, true);
...
SELECT pg_catalog.setval('public.payroll_records_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.principal_attendance_id_seq', 163, true);
...
SELECT pg_catalog.setval('public.school_timetable_id_seq', 96, true);
...
SELECT pg_catalog.setval('public.standard_subjects_std_subject_id_seq', 146, true);
...
SELECT pg_catalog.setval('public.teacher_attendance_attendance_id_seq', 251, true);
