...
1	\N	LP SAVANI CANAL ROAD	lpsavani@gmail.com	8974589654	2024-08-06	Government	{State}	{English,Hindi}	{Pre-Primary,Primary,Secondary}	Surat	\N	\N	33.00
2	\N	MANIDHAR	mani@gmail.com	7452639812	2025-08-07	Private	{State}	{Hindi}	{Primary,"Upper Primary"}	Adajan	\N	\N	33.00
4	/BMC-SMS/uploads/school_logos/school_4_1754557425.jpg	sanskar bharti vidyalay	sbv@gmail.com	8526548525	2025-07-06	Private	{CBSE}	{Hindi}	{Primary}	adajan	21.21060270	72.76795460	20.00
\.
...
6	pages/teacher/uploads/teacher_68930b772460d7.80848358.jpg	meet parekh	9900990099	4	2025-07-01	Male	B-	mota varachaa	otherswayam@gmail.com	$2y$10$sdz4DZ5oaMJNrUA9mld44uiBNIIkAQCPjs2XrrnUcl.Bp6wlzYz1a	B.A	maths	english	100000	{8,9,10,11,12}	10	Evening	t	11
\.
...
14	6	4	2025-08-06	Absent	\N	10	2025-08-07 09:17:45.150076+00
15	6	4	2025-08-30	Leave	\N	10	2025-08-07 09:19:11.792668+00
5	6	4	2025-08-07	Absent	\N	10	2025-08-07 09:21:34.212168+00
\.
...
6	teacher	otherswayam@gmail.com	$2y$10$sdz4DZ5oaMJNrUA9mld44uiBNIIkAQCPjs2XrrnUcl.Bp6wlzYz1a	active	\N	\N
...
SELECT pg_catalog.setval('public.librarian_attendance_attendance_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.principal_attendance_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.principal_timings_timing_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.principal_to_bmc_notices_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.school_notice_recipients_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.school_notices_content_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.teacher_attendance_attendance_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.teacher_timings_timing_id_seq', 14, true);
