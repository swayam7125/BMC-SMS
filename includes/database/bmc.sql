...
VALUES (
    ...
    'maths',
    'chbjdcj',
    '/BMC-SMS/pages/assignments/uploads/assign_688223fef08ce9.86748149_INTERNSHIP REGISTRATION FORM JAY (4).pdf',
    'INTERNSHIP REGISTRATION FORM JAY (4).pdf',
    '2025-08-17',
    '2025-07-24 12:15:58'
  ),
  (
    ...
    'E-commerce',
    'bla bla bla',
    '/BMC-SMS/pages/assignments/uploads/assign_688250b98aad84.59696407_Chapter 2- Consumer oriented E-Commerce E-Retailing (1) (1).pdf',
    'Chapter 2- Consumer oriented E-Commerce E-Retailing (1) (1).pdf',
    '2025-08-18',
    '2025-07-24 15:26:49'
  );
-- --------------------------------------------------------
...
VALUES (
    ...
    3,
    3,
    '/BMC-SMS/pages/assignments/submit/sub_688226f95aae52.40718307_PROJECT college.pdf',
    'PROJECT college.pdf',
    'Submitted',
    '2025-07-24 12:28:41'
  ),
  (
    ...
    4,
    3,
    '/BMC-SMS/pages/assignments/submit/sub_688250ec596326.79398413_PROJECT college.pdf',
    'PROJECT college.pdf',
    'Submitted',
    '2025-07-24 15:27:40'
  );
...
VALUES (1, 3, 6, 4, '11', '2025-07-24', 'Present', NULL);
-- --------------------------------------------------------
--
...
CREATE TABLE `deleted_schools` (
  ...
  `education_board`
  set('CBSE', 'State', 'IGCSE') DEFAULT NULL,
    `school_medium`
  set('English', 'Hindi', 'Regional Language') DEFAULT NULL,
    `school_category`
  set(
      'Pre-Primary',
      'Primary',
...
VALUES (
    ...
    'Fee',
    'BLAW BLAW',
    '/BMC-SMS/pages/teacher/uploads/note_6882136a28ca99.45092353_INTERNSHIP REGISTRATION FORM JAY.pdf',
    'INTERNSHIP REGISTRATION FORM JAY.pdf',
    '2025-07-24 11:05:14'
  ),
  (
    4,
    ...
    'E-commerce',
    'more contant',
    '/BMC-SMS/pages/teacher/uploads/note_68824bfc04afc6.93915743_Chapter 2- Consumer oriented E-Commerce E-Retailing (1).pdf',
    'Chapter 2- Consumer oriented E-Commerce E-Retailing (1).pdf',
    '2025-07-24 15:06:36'
  );
-- --------------------------------------------------------
--
...
VALUES (
    ...
    'Fenil Pastagia',
    'fenil@gmail.com',
    '$2y$10$EaSZM1Mq/otD2L1wHMoZdefcPjkOWeXPjePcvdj5WLY/6Lx5DxrJ6',
    '9924976503',
    '1980-08-17',
    'Male',
    'B+',
...
VALUES (1, 10, 'Monday', '06:00:00', '17:00:00', 0),
...
--
INSERT INTO `standard_subjects` (`std_subject_id`, `standard`, `subject_id`)
VALUES (1, '1', 1),
  (4, '1', 2),
  (6, '1', 3),
  (3, '1', 11),
...
VALUES (
    ...
    '11',
    'devam@gmail.com',
    '$2y$10$vl/hHLMF3ar5GEc6pQJfVexTt3vKCXoAGF/9HcDtgGGDsfKHoXHQu',
    '2024-2025',
    4,
    '2025-07-11',
    'male',
...
VALUES (
    6,
    '../../pages/teacher/uploads/teacher_6880cd02b30464.45441036.jpg',
    'Meet Patel',
    '9900990099',
    4,
    '2025-07-01',
    ...
    'mota varachaa',
    'meet@gmail.com',
    '$2y$10$sdz4DZ5oaMJNrUA9mld44uiBNIIkAQCPjs2XrrnUcl.Bp6wlzYz1a',
    'B.A',
    'maths',
    'english',
    100000,
...
VALUES (8, 6, 'Monday', '11:04:00', '18:00:00', 0),
...
VALUES (
    ...
    '11',
    6,
    '/BMC-SMS/pages/teacher/uploads/timetables/tt_6882190a814100.28997107_INTERNSHIP REGISTRATION FORM JAY.pdf',
    'INTERNSHIP REGISTRATION FORM JAY.pdf',
    '2025-07-24 11:29:14'
  ),
  (
    ...
    '11',
    6,
    '/BMC-SMS/pages/teacher/uploads/timetables/tt_68824bdc56c401.66632629_Chapter 2- Consumer oriented E-Commerce E-Retailing (1).pdf',
    'Chapter 2- Consumer oriented E-Commerce E-Retailing (1).pdf',
    '2025-07-24 15:06:04'
  );
-- --------------------------------------------------------
...
VALUES (
  ...
  (
    ...
    'bmc',
    'swayam@gmail.com',
    '$2y$10$T74F9Gb05l.StKcZg2sy/ub6PHeH.l3tT3Lv1JwOZzioXJCdEN0zO'
  ),
  (
    10,
    'schooladmin',
...
ADD PRIMARY KEY (`mark_id`),
  ADD UNIQUE KEY `uq_student_exam_subject` (
    `student_id`,
    `academic_year`,
    `exam_type`,
    `subject_name`
...
ADD CONSTRAINT `student_marks_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`) ON DELETE CASCADE,
  ...
  ADD CONSTRAINT `student_marks_ibfk_3` FOREIGN KEY (`entered_by_user_id`) REFERENCES `users` (`id`) ON DELETE
SET NULL;
--
