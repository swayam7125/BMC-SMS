            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="student_list.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="student_image"
                                                        name="student_image"
                                                        value="<?php echo htmlspecialchars($student['student_image']); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="std" name="std"
                                                        value="<?php echo htmlspecialchars($student['std']); ?>"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="gender" name="gender">
                                                        ...
                                                        <option value="female"
                                                            ...
                                                            Female</option>
                                                        <option value="others"
                                                            <?php echo ($student['gender'] == 'others') ? 'selected' : ''; ?>>
                                                            Others</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="blood_group" name="blood_group">
                                                        ...
                                                        <option value="a+"
                                                            <?php echo ($student['blood_group'] == 'a+') ? 'selected' : ''; ?>>
                                                            A+</option>
                                                        <option value="a-"
                                                            <?php echo ($student['blood_group'] == 'a-') ? 'selected' : ''; ?>>
                                                            A-</option>
                                                        <option value="b+"
                                                            <?php echo ($student['blood_group'] == 'b+') ? 'selected' : ''; ?>>
                                                            B+</option>
                                                        <option value="b-"
                                                            <?php echo ($student['blood_group'] == 'b-') ? 'selected' : ''; ?>>
                                                            B-</option>
                                                        <option value="ab+"
                                                            <?php echo ($student['blood_group'] == 'ab+') ? 'selected' : ''; ?>>
                                                            AB+</option>
                                                        <option value="ab-"
                                                            <?php echo ($student['blood_group'] == 'ab-') ? 'selected' : ''; ?>>
                                                            AB-</option>
                                                        <option value="o+"
                                                            <?php echo ($student['blood_group'] == 'o+') ? 'selected' : ''; ?>>
                                                            O+</option>
                                                        <option value="o-"
                                                            <?php echo ($student['blood_group'] == 'o-') ? 'selected' : ''; ?>>
                                                            O-</option>
