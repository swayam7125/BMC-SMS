...
if ($student_id <= 0) {
    header("Location: ../../extra/student_tables.php?error=Invalid student ID");
    exit;
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                            <a href="../../extra/student_tables.php" class="btn btn-secondary btn-sm mr-2">
                                ...
                                <div class="card-body">
                                    <div class="photo-container">
                                        <?php if (!$show_default): ?>
                                            ...
                                            <small class="text-muted mt-2" style="display: none;">Photo not available</small>
                                        <?php else: ?>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['student_name'] ?? 'N/A'); ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-4 font-weight-bold">Roll Number:</div>
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['rollno'] ?? 'N/A'); ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-4 font-weight-bold">Standard:</div>
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['std'] ?? 'N/A'); ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['academic_year'] ?? 'N/A'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8"><?php echo htmlspecialchars(ucfirst($student['gender'] ?? 'N/A')); ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-4 font-weight-bold">Blood Group:</div>
                                        <div class="col-sm-8"><?php echo htmlspecialchars(strtoupper($student['blood_group'] ?? 'N/A')); ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-4 font-weight-bold">Address:</div>
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['address'] ?? 'N/A'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['school_name'] ?? 'N/A'); ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-4 font-weight-bold">School Address:</div>
                                        <div class="col-sm-8"><?php echo htmlspecialchars($student['school_address'] ?? 'N/A'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8"><?php echo htmlspecialchars($student['father_name'] ?? 'N/A'); ?></div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php if ($student['father_phone']): ?>
                                                        <a href="tel:<?php echo htmlspecialchars($student['father_phone']); ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8"><?php echo htmlspecialchars($student['mother_name'] ?? 'N/A'); ?></div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php if ($student['mother_phone']): ?>
                                                        <a href="tel:<?php echo htmlspecialchars($student['mother_phone']); ?>">
