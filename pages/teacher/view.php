                            ...
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 info-value"><?php if ($teacher['class_teacher'] == 1): ?><span class="badge badge-success">Yes</span><small class="text-muted"> (Std: <?php echo htmlspecialchars($teacher['class_teacher_std']); ?>)</small><?php else: ?><span class="badge badge-secondary">No</span><?php endif; ?></div>
                                    </div>
                                    <hr>
                                    <div class="row">
