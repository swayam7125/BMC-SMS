...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['application_id'])) {
    ...
    // REMOVED: $student_roll_no, $student_class
    ...
    // UPDATED VALIDATION: Now only checks for meeting date/time if Accepted
        ...
        try {
            ...
            $success = $stmt->execute([
                ...
                ':remarks' => $comment,
                // Assigning NULL to roll_no and class as they are now removed fields
...
<head>
    ...
    <link href="../../assets/vendor/datatables/dataTables.bootstrap4.min.css" rel1="stylesheet">
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '.status-radio', function() {
                ...
                if (action === 'Accepted') {
                    ...
                    // Only Meeting Date/Time are required now.
                    $('#meeting_date, #meeting_time').prop('required', true); 
