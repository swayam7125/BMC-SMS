...
try {
    // This query correctly fetches from the 'hr_payroll' table for the logged-in user.
    $stmt = $conn->prepare(
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="../hr/download_slips.php" method="POST" target="_blank">
                                ...
                                <small class="text-muted">Note: Bulk download requires a server-side PDF generation library to be installed and configured.</small>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="../hr/generate_slip.php?id=<?php echo encrypt_id($record['id']); ?>&type=hr" target="_blank" class="btn btn-sm btn-info">
