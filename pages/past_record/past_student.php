                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Deleted Students Log</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="pastStudentTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Email</th>
                                    ...
                                    <tbody>
                                        <?php if (!empty($deleted_students)): ?>
                                            <?php foreach ($deleted_students as $row): ?>
                                                <tr>
                                            ...
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr><td colspan="7" class="text-center">No deleted students found</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
...
?>
    ...
    <script>
        $(document).ready(function() {
            $('#pastStudentTable').DataTable({ "order": [[ 6, "desc" ]] });
        });
    </script>
</body>
</html>
