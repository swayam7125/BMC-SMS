...
try {
    ...
    $deleted_teachers = $stmt->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Deleted Teachers Log</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="pastTeacherTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php if (!empty($deleted_teachers)): ?>
                                            <?php foreach ($deleted_teachers as $row): ?>
                                                <tr>
                                            ...
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr><td colspan="7" class="text-center">No deleted teachers found</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
...
?>
    ...
    <script>
        $(document).ready(function() {
            $('#pastTeacherTable').DataTable({ "order": [[ 6, "desc" ]] });
        });
    </script>
</body>
</html>
