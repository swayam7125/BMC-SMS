...
// This function is needed for calculations, copied from dashboard.php
...
try {
    ...
    // Determine the month and year for payroll
    ...
    if (isset($_GET['month'])) {
        ...
        // 2. Get all existing payroll records for this month to check status
        ...
        // 3. Calculate salary for each teacher
        foreach ($teachers as $teacher) {
            $base_salary = $teacher['salary'];
            $total_working_days = getWorkingDays($filter_year, $filter_month);
