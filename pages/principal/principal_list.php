                                ...
                                <table class="table table-bordered" id="principalListTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php if ($result && mysqli_num_rows($result) > 0): ?>
                                            ...
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr><td colspan="6" class="text-center">No principals found</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
